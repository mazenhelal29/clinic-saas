...
import { Activity, ShieldCheck, Stethoscope, Users, Calendar, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background selection:bg-primary/20">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[30%] h-[30%] rounded-full bg-blue-500/5 blur-[100px] animate-pulse delay-700" />
      </div>

      {/* Header */}
      <header className="px-6 lg:px-12 h-20 flex items-center border-b sticky top-0 bg-background/80 backdrop-blur-xl z-50 transition-all">
      ...
      <main className="flex-1 relative z-10">
        ...
        <section className="relative w-full py-24 lg:py-40 px-6 overflow-hidden">
          <div className="container mx-auto text-center space-y-12 animate-fade-in">
            ...
            <h1 className="text-5xl font-black tracking-[calc(-0.04em)] sm:text-7xl lg:text-8xl max-w-5xl mx-auto leading-[0.95]">
            ...
            <p className="mx-auto max-w-2xl text-muted-foreground md:text-xl lg:text-2xl leading-relaxed font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8">
              <Button size="lg" className="h-16 px-12 rounded-2xl text-xl font-bold gap-3 shadow-xl shadow-primary/20 group" asChild>
                <Link href="/register" prefetch={true}>
                  ابدأ تجربتك المجانية 
                  <ArrowLeft className="h-6 w-6 transition-transform group-hover:-translate-x-1" />
                </Link>
              </Button>
              <Button size="lg" variant="outline" className="h-16 px-12 rounded-2xl text-xl font-bold bg-background/50 backdrop-blur-sm border-muted-foreground/20" asChild>
            ...
            <div className="pt-24 space-y-8">
              ...
              <div className="flex flex-wrap justify-center items-center gap-12 lg:gap-20 opacity-30 grayscale hover:opacity-100 hover:grayscale-0 transition-all duration-700">
                {['المستشفى السعودي', 'مجمع الشفاء', 'عيادات الحياة', 'مركز النور', 'مجموعة العبير'].map(name => (
                  <div key={name} className="font-black text-2xl tracking-tighter text-foreground">{name}</div>
                ))}
              </div>
            </div>
          </div>
        ...
        {/* Features Section */}
        <section id="features" className="w-full py-32 bg-muted/20 px-6 relative">
          <div className="container mx-auto">
            <div className="text-center mb-24 space-y-4">
              <h2 className="text-4xl font-black sm:text-6xl tracking-tight">قوة التكنولوجيا بين يديك</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {[
                ...
                <div key={i} className="group relative bg-background p-10 rounded-[2.5rem] border border-muted-foreground/10 shadow-sm hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500 hover:-translate-y-2 overflow-hidden">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 rounded-bl-full transition-transform group-hover:scale-150 duration-700" />
        ...
        {/* Stats Section */}
        <section id="stats" className="w-full py-32 px-6">
          <div className="container mx-auto bg-primary rounded-[3rem] p-12 lg:p-24 relative overflow-hidden shadow-2xl shadow-primary/30">
