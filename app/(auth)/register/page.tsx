...
import { Building, Globe, Loader2, Lock, Mail, ShieldCheck, Stethoscope, User, Zap } from 'lucide-react';
      ...
      <div className="w-full max-w-[580px] space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-700 relative z-10">
        ...
        <Card className="p-8 sm:p-12 border-none shadow-[0_20px_50px_rgba(0,0,0,0.05)] dark:shadow-none bg-white/80 dark:bg-slate-900/50 backdrop-blur-xl rounded-[3rem]">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-black text-slate-800 dark:text-white">سجل عيادتك الآن</h2>
            <p className="text-slate-500 text-sm mt-2 font-medium">ابدأ إدارة عيادتك من منصة واحدة واضحة وسريعة</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label className="text-sm font-black text-slate-900 dark:text-white mr-1">اسم العيادة</Label>
                <div className="relative">
                  <Building className="absolute right-4 top-4 h-5 w-5 text-slate-500" />
                  <Input
                    placeholder="عيادة النور"
                    className="h-13 pr-12 rounded-2xl border-slate-200 bg-white dark:bg-slate-950 text-slate-900 dark:text-white focus:ring-primary/20 focus:border-primary transition-all font-bold placeholder:text-slate-300"
              ...
              <div className="space-y-2">
                <Label className="text-sm font-black text-slate-900 dark:text-white mr-1">اسمك الكامل</Label>
                <div className="relative">
            ...
            <div className="space-y-2">
              <Label className="text-sm font-black text-slate-900 dark:text-white mr-1">البريد الإلكتروني</Label>
              <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label className="text-sm font-black text-slate-900 dark:text-white mr-1">كلمة المرور</Label>
                <div className="relative">
              ...
              <div className="space-y-2">
                <Label className="text-sm font-black text-slate-900 dark:text-white mr-1">تأكيد كلمة المرور</Label>
                <div className="relative">
                  <Lock className="absolute right-4 top-4 h-5 w-5 text-slate-500" />
                  <Input
                    type="password"
